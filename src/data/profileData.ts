  ...
  experience: [
    {
      ...
      period: "2014年8月 - 現在",
      description:
        "様々な企業のプロジェクトに参画し、バックエンド開発を中心に活動。Go言語、TypeScript、React、Next.jsなどを用いたマイクロサービス開発やAPIサーバー構築、AI技術を活用したプロダクト開発を行っています。",
    },
    {
...
export const newsItems: NewsItem[] = [
  {
    ...
    content:
      '「AI"も"使えるエンジニア」をテーマに、ポートフォリオサイトをリニューアルしました。',
  },
  {
    date: "2023年9月〜2025年1月",
    title: "介護施設管理システム開発プロジェクト参画",
    content:
      "AIを活用した介護施設管理システムの開発に参画。法令関連のデータモデル設計とAPI実装を担当。",
  },
  {
    date: "2022年10月〜2023年4月",
    title: "共通認証マイクロサービス開発",
    content:
      "B2B/B2Cマッチングサービス向けの共通認証マイクロサービスをGo言語で開発。",
  },
  {
    date: "2022年7月〜2022年12月",
    title: "建築設計データ解析/API開発",
    content:
      "Autodesk Construction Cloudデータを解析するRESTful APIをGo言語で開発。",
  },
];
