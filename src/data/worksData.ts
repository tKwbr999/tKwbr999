...
export const worksData: WorkItem[] = [
  {
    id: "project1",
    title: "Goチートシート（日本語版）",
    description: "ぱっと見でわかるGo言語の文法ガイド。初学者から実務者まで活用できる実用的なチートシート。Go言語の基本構文から応用的なパターンまでをわかりやすく整理しています。",
  ...
  },
  {
    ...
    description: "学習用tailwindcssのテキスト。視認性と使いやすさにこだわった設計で、実務でも貢献できるクオリティを実現。実践的な例と解説で効率的な学習をサポートします。",
